...
const SharedInvoice = () => {
  ...
  useEffect(() => {
    const fetchBooking = async () => {
      try {
        const res = await axios.get(`https://regalia-backend.vercel.app/api/banquet-bookings/${id}`);
        setBooking(res.data);
      } catch (error) {
  ...
  const handleShareWhatsApp = async () => {
    ...
    if (pdf) {
      ...
      const message = `Hi ${booking.name}, here is your booking invoice from BUDDHA. Please find the PDF attachment.`;
        ...
        <div ref={invoiceRef} className="bg-white shadow-lg rounded-lg overflow-hidden print:shadow-none print:rounded-none">
          ...
          <div className="px-8 py-6 print:px-4 print:py-3">
            ...
            <div className="border-t border-gray-200 pt-6 text-center text-sm text-gray-600 print:pt-3 print:text-xs print:text-black">
              <p className="mb-2 print:mb-1">Thank you for choosing BUDDHA!</p>
